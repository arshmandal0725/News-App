...
class NewsDescription extends StatefulWidget {
  ...
  String newsContent;
  String newsSource;
  NewsDescription(this.newsImage, this.newsTitle, this.newsDate,
      this.newsAuthor, this.newsDesc, this.newsContent, this.newsSource);

  @override
  State<NewsDescription> createState() => _NewsDetailScreenState();
}

class _NewsDetailScreenState extends State<NewsDescription> {
