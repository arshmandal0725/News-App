...
class Articles {
  ...
  Articles.fromJson(Map<String, dynamic> json) {
    ...
    author = json['author']??'No Info';
    title = json['title']??'No Info';
    description = json['description'] ?? 'No Info';
    url = json['url']??'No Info';
    urlToImage = json['urlToImage'] ?? '';
    publishedAt = json['publishedAt']??'No Info';
    content = json['content']??'No Info';
  }
